package self.explore.generics.version1;
...
/*
 * Changed the GenericList class so that it implements the Iterable interface 
 * in order to demonstrate how to implement an iterator using an inner class.
 * */
...
public class GenericList implements Iterable {
    ...
    private class GenericListIterator implements Iterator {
        ...
        public void remove(){
            ...
            removeOK = false;
            GenericList.this.remove(position - 1);
            position--;
        }
    }
