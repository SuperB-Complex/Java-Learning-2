package self.explore.generics.original;
 ...
 *
 */
public class GenericListOriginalVersion {
     ...
     */
    public GenericListOriginalVersion() {
     ...
     * @param initialCap > 0
     */    
    public GenericListOriginalVersion(int initialCap) {
    ...
    // to be honest, I don't think you overrides equals
    // besides once you overrides the equals you should override hashCode()
   /**
...
//            result = true;
//        	// getClass returns true only when the two classes are same
//        else if (this.getClass() != other.getClass())
//            // other is not an IntList they can't be equal
//            result = false;
//        else {
//            // other is not null and refers to an IntList
//        	GenericListOriginalVersion otherList = (GenericListOriginalVersion)other;
